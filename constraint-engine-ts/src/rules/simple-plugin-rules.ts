...
export const simplePluginRules: ConstraintRule[] = [
  createRule()
  ...
  createRule()
    ...
    .validate((context) => {
      ...
      const matches = ValidationHelpers.findMatches(context.content, consolePattern);
  ...
  createRule()
    ...
    .validate((context) => {
      ...
      const matches = ValidationHelpers.findMatches(context.content, secretPattern);
